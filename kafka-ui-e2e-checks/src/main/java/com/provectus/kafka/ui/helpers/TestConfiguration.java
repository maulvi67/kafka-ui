...
public class TestConfiguration {
  ...
  public static String IMAGE_NAME = System.getProperty("SELENIUM_DOCKER_IMAGE", "seleniarm/standalone-chromium");
  public static String IMAGE_TAG = System.getProperty("SELENIUM_IMAGE_TAG", "latest");
